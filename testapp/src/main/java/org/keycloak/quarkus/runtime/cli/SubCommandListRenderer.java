...
/**
 * A {@link CommandLine.IHelpSectionRenderer} based on Quarkus CLI to show subcommands in help messages.
 */
class SubCommandListRenderer implements CommandLine.IHelpSectionRenderer {
    ...
    private void addHierarchy(Collection<CommandLine> collection, TextTable textTable,
            String indent) {
